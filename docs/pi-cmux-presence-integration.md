...
> **상태:** shared [`@pi/presence` protocol (v2-20260907-1)](https://github.com/spi-ca/pi-presence/tree/v2-20260907-1) 기반 producer

공유 채널, schema, consumer discovery/replay, generation·sequence fence와 registry lifecycle은 canonical [`@pi/presence` protocol (v2-20260907-1)](https://github.com/spi-ca/pi-presence/tree/v2-20260907-1)을 따른다. 이 문서는 그 위에 얹는 `pi-subagent` 투영만 설명한다.
...
`@pi/presence`는 runtime dependency와 lockfile에서 `github:spi-ca/pi-presence#v2-20260907-1`로 정확히 고정한다.
