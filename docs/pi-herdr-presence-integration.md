...
> **상태:** shared [`@pi/presence` protocol (v2-20260907-1)](https://github.com/spi-ca/pi-presence/tree/v2-20260907-1) 기반 producer; consumer UI는 별도 package 책임

`pi-subagent` root parent만 `subagent` source를 shared registry에 투영한다. shared protocol의 채널, schema, replay, fence와 registry lifecycle은 canonical [`@pi/presence` protocol (v2-20260907-1)](https://github.com/spi-ca/pi-presence/tree/v2-20260907-1)을 따른다.
